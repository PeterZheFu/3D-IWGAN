...
parser.add_argument('-e','--epochs', default=150000000, help ='The number of epochs to run for.', type=int)
...
parser.add_argument('-l', '--load', default= True, help='Indicates if a previously loaded model should be loaded.', action = 'store_true')
